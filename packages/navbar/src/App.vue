        ...
        <ul>
          <li>
            <router-link
              ...
              class="nav-link"
              active-class="active-nav-link"
              >View dogs dashboard</router-link
            >
          </li>
        </ul>
        <ul>
